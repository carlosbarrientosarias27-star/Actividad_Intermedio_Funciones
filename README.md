...
.qodo/: Configuración técnica del entorno de desarrollo (opcional).
...
cd ACTIVIDAD_INTERMEDIO_FUNCIONES
Requisitos:

Tener instalado Python 3.x.

No se requieren dependencias externas adicionales (usa bibliotecas estándar de Python).
...
Bash
python -m Parte_5.analizar_notas